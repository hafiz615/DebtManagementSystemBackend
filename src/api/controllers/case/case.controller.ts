...
class CaseController {
  ...
  updateCaseAffiliation = async (req: Request, res: Response) => {
    try {
  ...
  updateCasePlanDebtorPortal = async (req: Request, res: Response) => {
    try {
    ...
    try {
      ...
      return res.status(constants.CODE.OK).send(
        responseHelper.get2xxResponse({
          statusCode: constants.CODE.OK,
          data: response[1],
          message: constants.successFoundMessage('User Cases'),
        })
      );
    } catch (error: any) {
      console.log(error);
  ...
  updateLegalFee = async (req: Request, res: Response) => {
    try {
  ...
  updateCasePriority = async (req: Request, res: Response) => {
    try {
      const response = await this.caseService.updateCasePriority(req);
      if (!response[0]) {
        return res
          .status(constants.CODE.BAD_REQUEST)
          .send(responseHelper.get4xxResponse(response[1]));
      ...
      return res.status(constants.CODE.OK).send(
        responseHelper.get2xxResponse({
          statusCode: constants.CODE.OK,
          data: response[1],
          message: constants.successUpdateMessage('Priority'),
        })
      );
    } catch (error: any) {
      console.log(error.message);
  ...
  deleteCasePriority = async (req: Request, res: Response) => {
    try {
      const response = await this.caseService.deleteCasePriority(req);
      if (!response[0]) {
        return res
          .status(constants.CODE.BAD_REQUEST)
          .send(responseHelper.get4xxResponse(response[1]));
