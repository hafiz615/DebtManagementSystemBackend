...
class DebtorController {
  ...
  getDebtorPayments = async (req: Request, res: Response) => {
    try {
  ...
  getTopPayees = async (req: Request, res: Response) => {
    try {
  ...
  updateCommisionPercentage = async (req: Request, res: Response) => {
    try {
      ...
      return res.status(constants.CODE.OK).send(
        responseHelper.get2xxResponse({
          statusCode: constants.CODE.OK,
          data: response[1],
          message: constants.successUpdateMessage('Commision'),
        })
      );
    } catch (error) {
      console.log(error);
  ...
  debtorCreditorPaymentPlanDetail = async (req: Request, res: Response) => {
    try {
      const response =
        await this.debtorService.debtorCreditorPaymentPlanDetail(req);
      if (!response[0]) {
        return res
          .status(constants.CODE.BAD_REQUEST)
          .send(responseHelper.get4xxResponse(response[1]));
      ...
      return res.status(constants.CODE.OK).send(
        responseHelper.get2xxResponse({
          statusCode: constants.CODE.OK,
          data: response[1],
          message: constants.successFoundMessage('Payment plan'),
        })
      );
    } catch (error) {
      console.log(error);
  ...
  getDebtorAccounts = async (req: Request, res: Response) => {
    try {
      const response = await this.debtorService.getDebtorAccounts(req);
      if (!response[0]) {
        return res
          .status(constants.CODE.OK)
          .send(responseHelper.get4xxResponse(response[1]));
      ...
      return res.status(constants.CODE.OK).send(
        responseHelper.get2xxResponse({
          statusCode: constants.CODE.OK,
          data: response[1],
          message: constants.successFoundMessage('Debtor accounts'),
        })
      );
    } catch (error) {
      console.log(error);
  ...
  makeAccountPrimary = async (req: Request, res: Response) => {
    try {
      const response = await this.debtorService.makeAccountPrimary(req);
      if (!response[0]) {
        return res
          .status(constants.CODE.BAD_REQUEST)
          .send(responseHelper.get4xxResponse(response[1]));
