...
class PaymentController {
  ...
  getCreditorSuccessfulPayments = async (req: Request, res: Response) => {
    try {
      const checkPermission = await commonUtil.checkPermission(
        'viewHomeScreen',
        req
      ...
      const response =
        await this.paymentService.getCreditorSuccessfulPayments(req);
      if (!response[0]) {
        return res
          .status(constants.CODE.OK)
          .send(responseHelper.get4xxResponse(response[1]));
  ...
  getCreditorUpcomingPayments = async (req: Request, res: Response) => {
    try {
      const checkPermission = await commonUtil.checkPermission(
        'viewHomeScreen',
        req
      ...
      const response =
        await this.paymentService.getCreditorUpcomingPayments(req);
      if (!response[0]) {
        return res
          .status(constants.CODE.OK)
          .send(responseHelper.get4xxResponse(response[1]));
  ...
  updateACHDetails = async (req: Request, res: Response) => {
    try {
      ...
      return res.status(constants.CODE.OK).send(
        responseHelper.get2xxResponse({
          statusCode: constants.CODE.OK,
          data: response[1],
          message: constants.successUpdateMessage('ACH details'),
        })
      );
    } catch (error: any) {
      console.log(error);
  ...
  updatePaymentInvoiceStatus = async (req: Request, res: Response) => {
    try {
      const response =
        await this.paymentService.updatePaymentInvoiceStatus(req);
      if (!response[0]) {
        return res
          .status(constants.CODE.OK)
          .send(responseHelper.get4xxResponse(response[1]));
  ...
  checkInvoice = async (req: Request, res: Response) => {
    try {
  ...
  getInstantPayment = async (req: Request, res: Response) => {
    try {
  ...
  getCaseAttorneyPayments = async (req: Request, res: Response) => {
    try {
  ...
  paynoteWebhook = async (req: Request, res: Response) => {
    try {
  ...
  getClientPendingChecks = async (req: Request, res: Response) => {
    try {
      ...
      return res.status(constants.CODE.OK).send(
        responseHelper.get2xxResponse({
          statusCode: constants.CODE.OK,
          data: response[1],
          message: constants.successFoundMessage('Client pending checks'),
        })
      );
    } catch (error) {
      console.log(error);
