...
class CallController {
  ...
  telnyxPhoneNo = async (req: Request, res: Response) => {
    try {
      ...
      return res.status(constants.CODE.OK).send(
        responseHelper.get2xxResponse({
          statusCode: constants.CODE.OK,
          data: response[1],
          message: constants.successFoundMessage('Phone No'),
        })
      );
    } catch (error) {
      console.log('error', error);
  ...
  telnyxCredentialsTokens = async (req: Request, res: Response) => {
    try {
      const response = await this.callService.telnyxCredentialsTokens(req);
      if (!response[0]) {
        return res
          .status(constants.CODE.BAD_REQUEST)
          .send(responseHelper.get4xxResponse(response));
      ...
      return res.status(constants.CODE.CREATED).send(
        responseHelper.get2xxResponse({
          statusCode: constants.CODE.CREATED,
          data: response[1],
          message: constants.successfullyMessage('Token Return'),
        })
      );
    } catch (error) {
      console.log('error', error);
  ...
  debtorAndCaseId = async (req: Request, res: Response) => {
    try {
      const response = await this.callService.debtorAndCaseId(req);
      if (!response[0]) {
        return res
          .status(constants.CODE.BAD_REQUEST)
          .send(responseHelper.get4xxResponse(response));
      ...
      return res.status(constants.CODE.OK).send(
        responseHelper.get2xxResponse({
          statusCode: constants.CODE.OK,
          data: response[1],
          message: constants.successfullyMessage('Debtor and case return'),
        })
      );
    } catch (error) {
      // console.log('error', error);
  ...
  markAsRead = async (req: Request, res: Response) => {
    try {
      const response = await this.callService.markAsRead(req);
      if (!response[0]) {
        return res
          .status(constants.CODE.BAD_REQUEST)
          .send(responseHelper.get4xxResponse(response));
  ...
  missCalls = async (req: Request, res: Response) => {
    try {
      const response = await this.callService.missCalls(req);
      if (!response[0]) {
        return res
          .status(constants.CODE.BAD_REQUEST)
          .send(responseHelper.get4xxResponse(response));
      ...
      return res.status(constants.CODE.OK).send(
        responseHelper.get2xxResponse({
          statusCode: constants.CODE.OK,
          data: response[1],
          message: constants.successFoundMessage('Miss call'),
        })
      );
    } catch (error) {
      // console.log('error', error);
