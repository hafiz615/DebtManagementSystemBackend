...
const pipelineStatus = new mongoose_1.Schema({
    pipeline: {
        type: String,
    },
    status: {
...
exports.PipelineStatus = mongoose_1.default.model('pipelineStatus', pipelineStatus);
//# sourceMappingURL=pipelineStatus.model.js.map