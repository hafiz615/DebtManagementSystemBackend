...
// );
router.get('/retryAuth/:id', authorize_middleware_1.default.validateAuth, debtor_validate_1.default.retryPayment, debtor_controller_1.default.retryAuth);
router.get('/retryCapture/:id', authorize_middleware_1.default.validateAuth, debtor_validate_1.default.retryPayment, debtor_controller_1.default.retryCapture);
