...
router.post('/createUser', authorize_middleware_1.default.validateAuth, 
// authorize.validateRole,
user_validate_1.default.createUser, user_controller_1.default.createUser);
router.post('/signIn', user_validate_1.default.signIn, user_controller_1.default.signIn);
router.get('/getUserById/:id', authorize_middleware_1.default.validateAuth, 
// authorize.validateRole,
user_controller_1.default.getUserById);
router.get('/getUser', user_controller_1.default.getUser);
router.put('/updateUser', authorize_middleware_1.default.validateAuth, 
// authorize.validateRole,
user_validate_1.default.createUser, user_controller_1.default.updateUser);
...
router.delete('/deleteUserById/:id', authorize_middleware_1.default.validateAuth, 
// authorize.validateRole,
...
router.put('/forgotPassword', user_controller_1.default.updatePassword);
