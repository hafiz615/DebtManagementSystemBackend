...
router.post('/sendSmsEmailDebtorCreditor/:id', authorize_middleware_1.default.validateAuth, case_validate_1.default.sendEmail, email_controller_1.default.sendSmsEmailDebtorCreditor); // not in current use
