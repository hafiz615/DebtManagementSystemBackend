...
router.post('/update-invoice-status/:token', payment_validate_1.default.updatePaymentLinkStatus, payment_controller_1.default.updatePaymentInvoiceStatus);
router.post('/update-payment-status/:token', payment_validate_1.default.updatePaymentLinkStatus, payment_controller_1.default.updatePaymentLinkStatus);
