...
router.post('/syncPaynoteCreditor/:id', authorize_middleware_1.default.validateAuth, creditor_validate_1.default.syncEmail, creditor_controller_1.default.syncPaynote);
router.get('/getCreditorSyncEmail/:id', authorize_middleware_1.default.validateAuth, creditor_controller_1.default.getSyncEmail);
