...
class StatusController {
    constructor() {
        this.getCaseStatuses = async (req, res) => {
            try {
                ...
                return res.status(constants_util_1.default.CODE.OK).send(responseHelper_util_1.default.get2xxResponse({
                    ...
                    data: response[1],
                    message: constants_util_1.default.successFoundMessage('Statuses'),
                }));
            }
            catch (error) {
                console.log(error);
        ...
        this.addStatus = async (req, res) => {
            try {
                ...
                return res.status(constants_util_1.default.CODE.OK).send(responseHelper_util_1.default.get2xxResponse({
                    statusCode: constants_util_1.default.CODE.OK,
                    data: response[1],
                    message: constants_util_1.default.successAddMessage('Status'),
                }));
            }
            catch (error) {
                console.log(error);
        ...
        this.getStatusesById = async (req, res) => {
            try {
        ...
        this.updateStatusArray = async (req, res) => {
            try {
