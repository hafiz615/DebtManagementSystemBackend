...
class PipelineStatusController {
    constructor() {
        this.createPipeline = async (req, res) => {
            try {
                ...
                return res.status(constants_util_1.default.CODE.OK).send(responseHelper_util_1.default.get2xxResponse({
                    ...
                    data: response[1],
                    message: constants_util_1.default.successAddMessage('Pipeline'),
                }));
            }
            catch (error) {
                console.log(error);
        ...
        this.getAllPipelines = async (req, res) => {
            try {
                ...
                return res.status(constants_util_1.default.CODE.OK).send(responseHelper_util_1.default.get2xxResponse({
                    statusCode: constants_util_1.default.CODE.OK,
                    data: response[1],
                    message: constants_util_1.default.successFoundMessage('Pipelines'),
                }));
            }
            catch (error) {
                console.log(error);
        ...
        this.addStatusPipeline = async (req, res) => {
            try {
                ...
                return res.status(constants_util_1.default.CODE.OK).send(responseHelper_util_1.default.get2xxResponse({
                    statusCode: constants_util_1.default.CODE.OK,
                    data: response[1],
                    message: constants_util_1.default.successAddMessage('Pipeline status'),
                }));
            }
            catch (error) {
                return res
        ...
        this.getPipelineById = async (req, res) => {
            try {
                ...
                return res.status(constants_util_1.default.CODE.OK).send(responseHelper_util_1.default.get2xxResponse({
                    statusCode: constants_util_1.default.CODE.OK,
                    data: response[1],
                    message: constants_util_1.default.successFoundMessage('Pipeline'),
                }));
            }
            catch (error) {
                return res
        ...
        this.updatePipeline = async (req, res) => {
            try {
                ...
                return res.status(constants_util_1.default.CODE.OK).send(responseHelper_util_1.default.get2xxResponse({
                    statusCode: constants_util_1.default.CODE.OK,
                    data: response[1],
                    message: constants_util_1.default.successUpdateMessage('Pipeline'),
                }));
            }
            catch (error) {
                return res
        ...
        this.deletePipeline = async (req, res) => {
            try {
                ...
                return res.status(constants_util_1.default.CODE.OK).send(responseHelper_util_1.default.get2xxResponse({
                    statusCode: constants_util_1.default.CODE.OK,
                    data: response[1],
                    message: constants_util_1.default.successDeleteMessage('Pipeline'),
                }));
            }
            catch (error) {
                return res
        ...
        this.updateStatusPipeline = async (req, res) => {
            try {
        ...
        this.deleteStatusPipeline = async (req, res) => {
            try {
                ...
                return res.status(constants_util_1.default.CODE.OK).send(responseHelper_util_1.default.get2xxResponse({
                    statusCode: constants_util_1.default.CODE.OK,
                    data: response[1],
                    message: constants_util_1.default.successDeleteMessage('Status'),
                }));
            }
            catch (error) {
                return res
        ...
        this.getPipelineDetails = async (req, res) => {
            try {
                ...
                return res.status(constants_util_1.default.CODE.OK).send(responseHelper_util_1.default.get2xxResponse({
                    statusCode: constants_util_1.default.CODE.OK,
                    data: response[1],
                    message: constants_util_1.default.successFoundMessage('Pipeline details'),
                }));
            }
            catch (error) {
                console.log(error);
        ...
        this.getCasesByCustomFieldAndValue = async (req, res) => {
            try {
                const response = await this.pipelineStatusService.getCasesByCustomFieldAndValue(req);
                if (!response[0]) {
                    return res
                        .status(constants_util_1.default.CODE.OK)
                        .send(responseHelper_util_1.default.get4xxResponse(response[1]));
                ...
                return res.status(constants_util_1.default.CODE.OK).send(responseHelper_util_1.default.get2xxResponse({
                    statusCode: constants_util_1.default.CODE.OK,
                    data: response[1],
                    message: constants_util_1.default.successFoundMessage('Cases with custom field and value'),
                }));
            }
            catch (error) {
                console.log(error);
        ...
        this.pipelineStatusService = new pipelineStatus_service_1.default();
    }
}
exports.default = new PipelineStatusController();
//# sourceMappingURL=pipelineStatus.controller.js.map