...
class UploadController {
    constructor() {
        this.getLogsByTraceId = async (req, res) => {
            try {
                ...
                return res.status(constants_util_1.default.CODE.OK).send(responseHelper_util_1.default.get2xxResponse({
                    ...
                    data: response[1],
                    message: constants_util_1.default.successFoundMessage('Trace id logs'),
                }));
            }
            catch (error) {
                return res
        ...
        this.getLogsByTrackingId = async (req, res) => {
            try {
                ...
                return res.status(constants_util_1.default.CODE.OK).send(responseHelper_util_1.default.get2xxResponse({
                    statusCode: constants_util_1.default.CODE.OK,
                    data: response[1],
                    message: constants_util_1.default.successFoundMessage('Tracking id logs'),
                }));
            }
            catch (error) {
                return res
        ...
        this.loggingService = new logging_service_1.default();
    }
}
