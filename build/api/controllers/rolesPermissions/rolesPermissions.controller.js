...
const rolesPermissions_service_1 = __importDefault(require("../../services/rolesPermissions.service"));
...
class RolesPermissionsController {
    constructor() {
        this.createRole = async (req, res) => {
            try {
                ...
                return res.status(constants_util_1.default.CODE.OK).send(responseHelper_util_1.default.get2xxResponse({
                    ...
                    data: response[1],
                    message: constants_util_1.default.successAddMessage('Role'),
                }));
            }
            catch (error) {
                console.log(error);
        ...
        this.getAllRoles = async (req, res) => {
            ...
            try {
                ...
                return res.status(constants_util_1.default.CODE.OK).send(responseHelper_util_1.default.get2xxResponse({
                    statusCode: constants_util_1.default.CODE.OK,
                    data: response[1],
                    message: constants_util_1.default.successFoundMessage('Roles'),
                }));
            }
            catch (error) {
                console.log(error);
        ...
        this.getRoleById = async (req, res) => {
            try {
                ...
                return res.status(constants_util_1.default.CODE.OK).send(responseHelper_util_1.default.get2xxResponse({
                    statusCode: constants_util_1.default.CODE.OK,
                    data: response[1],
                    message: constants_util_1.default.successFoundMessage('Role'),
                }));
            }
            catch (error) {
                return res
        ...
        this.getRoleByName = async (req, res) => {
            try {
        ...
        this.updateRole = async (req, res) => {
            try {
                const checkPermission = await common_util_1.default.checkPermission('editRole', req);
                if (!checkPermission)
                    return res
                        .status(constants_util_1.default.CODE.BAD_REQUEST)
                        .send(responseHelper_util_1.default.get4xxResponse('You do not have permission to perform this operation'));
                ...
                return res.status(constants_util_1.default.CODE.OK).send(responseHelper_util_1.default.get2xxResponse({
                    statusCode: constants_util_1.default.CODE.OK,
                    data: response[1],
                    message: constants_util_1.default.successUpdateMessage('Role'),
                }));
            }
            catch (error) {
                return res
        ...
        this.deleteRole = async (req, res) => {
            try {
                const checkPermission = await common_util_1.default.checkPermission('deleteRole', req);
                if (!checkPermission)
                    return res
                        .status(constants_util_1.default.CODE.BAD_REQUEST)
                        .send(responseHelper_util_1.default.get4xxResponse('You do not have permission to perform this operation'));
                ...
                return res.status(constants_util_1.default.CODE.OK).send(responseHelper_util_1.default.get2xxResponse({
                    statusCode: constants_util_1.default.CODE.OK,
                    data: response[1],
                    message: constants_util_1.default.successDeleteMessage('Role'),
                }));
            }
            catch (error) {
                console.log(error);
        ...
        this.rolesPermissionsService = new rolesPermissions_service_1.default();
    }
}
exports.default = new RolesPermissionsController();
//# sourceMappingURL=rolesPermissions.controller.js.map