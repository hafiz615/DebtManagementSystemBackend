                ...
                const response = [
                    true,
                    {
                        case: {
                            ...
                            ['contractDetails.signing_date']: 'contract signing Date',
                            ['contractDetails.loan_amount']: 'contract loan amount ',
                            ['contractDetails.payable_amount']: 'contract payable amount',
                            ['contractDetails.purchased_percentage']: 'contract purchased percentage',
                            ['contractDetails.repayment_amount']: 'contract repayment amount',
                            ['contractDetails.purchasePrice']: 'contract purchase Price',
                        },
                        debtor: {
                            ['basicInformation.fullName']: 'DebtorPersonal Full Name',
                            ...
                            ['businessInformation.fullName']: 'Debtor BusinessInformation Full Name',
                            ['businessInformation.companyName']: 'BusinessInformation Company Name',
                        },
                        creditor: {
                            ['basicInformation.fullName']: 'CreditorPersonal Full Name',
                            ['basicInformation.email']: 'CreditorPersonal Email',
                            ['basicInformation.phone']: 'CreditorPersonal Phone',
                            ['businessInformation.fullName']: '',
                        },
                        event: { value: 'Event Value', date: '' },
                        payment: {
