...
class InboxController {
    constructor() {
        ...
        this.updateDraftEmail = async (req, res) => {
            try {
                ...
                return res.status(constants_util_1.default.CODE.OK).send(responseHelper_util_1.default.get2xxResponse({
                    statusCode: constants_util_1.default.CODE.OK,
                    data: response[1],
                    message: constants_util_1.default.successUpdateMessage('Draft Email'),
                }));
            }
            catch (error) {
                console.log(error);
        ...
        this.updateDraftSms = async (req, res) => {
            try {
        ...
        this.inboxStatus = async (req, res) => {
            try {
                const response = await this.inboxService.inboxStatus(req);
                if (!response[0]) {
                    return res
                        .status(constants_util_1.default.CODE.BAD_REQUEST)
                        .send(responseHelper_util_1.default.get4xxResponse(response[1]));
