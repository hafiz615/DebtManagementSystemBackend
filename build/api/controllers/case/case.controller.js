...
class CaseController {
    constructor() {
        ...
        this.updateCaseAffiliation = async (req, res) => {
            try {
                const response = await this.caseService.updateCaseAffiliation(req);
                if (!response[0]) {
                    return res
                        .status(constants_util_1.default.CODE.BAD_REQUEST)
                        .send(responseHelper_util_1.default.get4xxResponse(response[1]));
        ...
        this.getScoresSettlementRange = async (req, res) => {
            try {
                if (!req.query.all) {
                ...
                if (req.query.hardReload && req.query.hardReload === 'true')
                    hardReload = 'true';
                const response = await this.caseService.getScoresSettlementRange(String(req.query.all), hardReload, req.body, req.params.id);
                if (!response[0]) {
                    return res
                        .status(constants_util_1.default.CODE.BAD_REQUEST)
                        .send(responseHelper_util_1.default.get4xxResponse(response[1]));
                ...
                return res.status(constants_util_1.default.CODE.OK).send(responseHelper_util_1.default.get2xxResponse({
                    statusCode: constants_util_1.default.CODE.OK,
                    data: response[1],
                    message: constants_util_1.default.successFoundMessage('Scores and Settlement range '),
                }));
            }
            catch (error) {
                console.log(error);
        ...
        this.getScoresSettlementByCommPercentage = async (req, res) => {
            try {
                const response = await this.caseService.getScoresSettlementByCommPercentage(req);
                if (!response[0]) {
                    return res
                        .status(constants_util_1.default.CODE.BAD_REQUEST)
                        .send(responseHelper_util_1.default.get4xxResponse(response[1]));
        ...
        this.getWeeklyAndTotalCommission = async (req, res) => {
            try {
                ...
                return res.status(constants_util_1.default.CODE.OK).send(responseHelper_util_1.default.get2xxResponse({
                    statusCode: constants_util_1.default.CODE.OK,
                    data: response[1],
                    message: constants_util_1.default.successFoundMessage('Weekly commission and total commission'),
                }));
            }
            catch (error) {
                console.log(error);
        ...
        this.sendSettlementEmail = async (req, res) => {
            try {
        ...
        this.caseHistory = async (req, res) => {
            try {
                ...
                return res.status(constants_util_1.default.CODE.OK).send(responseHelper_util_1.default.get2xxResponse({
                    statusCode: constants_util_1.default.CODE.OK,
                    data: response[1],
                    message: constants_util_1.default.successFoundMessage('Case history'),
                }));
            }
            catch (error) {
                console.log(error);
        ...
        this.saveJustification = async (req, res) => {
            try {
                ...
                return res.status(constants_util_1.default.CODE.OK).send(responseHelper_util_1.default.get2xxResponse({
                    statusCode: constants_util_1.default.CODE.OK,
                    data: response[1],
                    message: constants_util_1.default.successRegisterMessage('Justification'),
                }));
            }
            catch (error) {
                console.log(error);
        ...
        this.calculateIntervalsAmount = async (req, res) => {
            try {
        ...
        this.getSettlementJustifications = async (req, res) => {
            try {
                ...
                return res.status(constants_util_1.default.CODE.OK).send(responseHelper_util_1.default.get2xxResponse({
                    statusCode: constants_util_1.default.CODE.OK,
                    data: response[1],
                    message: constants_util_1.default.successFoundMessage('Settlement justifications'),
                }));
            }
            catch (error) {
                console.log(error);
        ...
        this.affiliateCasesFinancialSummary = async (req, res) => {
            try {
                const response = await this.caseService.affiliateCasesFinancialSummary(req);
                if (!response[0]) {
                    return res
                        .status(constants_util_1.default.CODE.BAD_REQUEST)
                        .send(responseHelper_util_1.default.get4xxResponse(response[1]));
                ...
                return res.status(constants_util_1.default.CODE.OK).send(responseHelper_util_1.default.get2xxResponse({
                    statusCode: constants_util_1.default.CODE.OK,
                    data: response[1],
                    message: constants_util_1.default.successFoundMessage('Affiliate cases payment'),
                }));
            }
            catch (error) {
                console.log(error);
        ...
        this.deleteFile = async (req, res) => {
            try {
                ...
                return res.status(constants_util_1.default.CODE.OK).send(responseHelper_util_1.default.get2xxResponse({
                    statusCode: constants_util_1.default.CODE.OK,
                    data: response[1],
                    message: constants_util_1.default.Messages.DELETE_FILES_SUCCESS,
                }));
            }
            catch (error) {
                return res
        ...
        this.updateContractDetails = async (req, res) => {
            try {
                ...
                return res.status(constants_util_1.default.CODE.OK).send(responseHelper_util_1.default.get2xxResponse({
                    statusCode: constants_util_1.default.CODE.OK,
                    data: response[1],
                    message: constants_util_1.default.successUpdateMessage('Contract details'),
                }));
            }
            catch (error) {
                return res
        ...
        this.deleteCreditor = async (req, res) => {
            try {
        ...
        this.updateCasePlan = async (req, res) => {
            try {
                ...
                return res.status(constants_util_1.default.CODE.OK).send(responseHelper_util_1.default.get2xxResponse({
                    statusCode: constants_util_1.default.CODE.OK,
                    data: response[1],
                    message: constants_util_1.default.successUpdateMessage('Creditor plan'),
                }));
            }
            catch (error) {
                console.log(error);
        ...
        this.updateCasePlanDebtorPortal = async (req, res) => {
            try {
                const response = await this.caseService.updateCasePlanDebtorPortal(req);
                if (!response[0]) {
                    return res
                        .status(constants_util_1.default.CODE.BAD_REQUEST)
                        .send(responseHelper_util_1.default.get4xxResponse(response[1]));
        ...
        this.getAllUserCases = async (req, res) => {
            try {
                ...
                return res.status(constants_util_1.default.CODE.OK).send(responseHelper_util_1.default.get2xxResponse({
                    statusCode: constants_util_1.default.CODE.OK,
                    data: response[1],
                    message: constants_util_1.default.successFoundMessage('User Cases'),
                }));
            }
            catch (error) {
                console.log(error);
        ...
        this.getScoresSettlementRangeDetails = async (req, res) => {
            try {
                if (!req.query.all) {
                    return [false, 'Query param missing'];
                }
                ...
                if (req.query.hardReload && req.query.hardReload === 'true')
                    hardReload = 'true';
                const response = await this.caseService.getScoresSettlementRangeDetails(String(req.query.all), hardReload, req.body, req.params.id);
                if (!response[0]) {
                    return res
                        .status(constants_util_1.default.CODE.BAD_REQUEST)
                        .send(responseHelper_util_1.default.get4xxResponse(response[1]));
        ...
        this.updateLegalFee = async (req, res) => {
            try {
                const response = await this.caseService.updateLegalFee(req);
                if (!response[0]) {
                    return res
                        .status(constants_util_1.default.CODE.BAD_REQUEST)
                        .send(responseHelper_util_1.default.get4xxResponse(response[1]));
