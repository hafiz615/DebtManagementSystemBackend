...
class CallController {
    constructor() {
        ...
        this.telnyxCredentialsTokens = async (req, res) => {
            try {
                ...
                return res.status(constants_util_1.default.CODE.CREATED).send(responseHelper_util_1.default.get2xxResponse({
                    statusCode: constants_util_1.default.CODE.CREATED,
                    data: response[1],
                    message: constants_util_1.default.successfullyMessage('Token Return'),
                }));
            }
            catch (error) {
                console.log('error', error);
        ...
        this.debtorAndCaseId = async (req, res) => {
            try {
                ...
                return res.status(constants_util_1.default.CODE.OK).send(responseHelper_util_1.default.get2xxResponse({
                    statusCode: constants_util_1.default.CODE.OK,
                    data: response[1],
                    message: constants_util_1.default.successfullyMessage('Debtor and case return'),
                }));
            }
            catch (error) {
                // console.log('error', error);
        ...
        this.missCalls = async (req, res) => {
            try {
                ...
                return res.status(constants_util_1.default.CODE.OK).send(responseHelper_util_1.default.get2xxResponse({
                    statusCode: constants_util_1.default.CODE.OK,
                    data: response[1],
                    message: constants_util_1.default.successFoundMessage('Miss call'),
                }));
            }
            catch (error) {
                // console.log('error', error);
