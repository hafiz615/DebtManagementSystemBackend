        ...
        this.getLumpSumAmount = async (req, res) => {
            try {
                ...
                return res.status(constants_util_1.default.CODE.OK).send(responseHelper_util_1.default.get2xxResponse({
                    statusCode: constants_util_1.default.CODE.OK,
                    data: response[1],
                    message: constants_util_1.default.successFoundMessage('Debtor lump-sum-amount'),
                }));
            }
            catch (error) {
                return res
        ...
        this.getFullProfitSettlement = async (req, res) => {
            try {
                ...
                return res.status(constants_util_1.default.CODE.OK).send(responseHelper_util_1.default.get2xxResponse({
                    statusCode: constants_util_1.default.CODE.OK,
                    data: response[1],
                    message: constants_util_1.default.successFoundMessage('Debtor profit settlement'),
                }));
            }
            catch (error) {
                console.log(error);
