...
class UserController {
    constructor() {
        ...
        this.getUsersByRole = async (req, res) => {
            try {
                ...
                return res.status(constants_util_1.default.CODE.OK).send(responseHelper_util_1.default.get2xxResponse({
                    statusCode: constants_util_1.default.CODE.OK,
                    data: response[1],
                    message: constants_util_1.default.successFoundMessage('All Users By Role'),
                }));
            }
            catch (error) {
                return res
        ...
        this.forgotPasswordUpdate = async (req, res) => {
            try {
        ...
        this.addSenderIdentity = async (req, res) => {
            try {
                ...
                return res.status(constants_util_1.default.CODE.OK).send(responseHelper_util_1.default.get2xxResponse({
                    statusCode: constants_util_1.default.CODE.OK,
                    data: response[1],
                    message: constants_util_1.default.successRegisterMessage('Sender identity'),
                }));
            }
            catch (error) {
        ...
        this.forgotPasswordLink = async (req, res) => {
            try {
                const response = await this.userService.forgotPasswordLink(req.body.email ? req.body.email : '');
                if (!response[0]) {
                    return res
                        .status(constants_util_1.default.CODE.BAD_REQUEST)
                        .send(responseHelper_util_1.default.get4xxResponse(response[1]));
        ...
        this.getVerifySenders = async (req, res) => {
            try {
                ...
                return res.status(constants_util_1.default.CODE.OK).send(responseHelper_util_1.default.get2xxResponse({
                    statusCode: constants_util_1.default.CODE.OK,
                    data: response[1],
                    message: constants_util_1.default.successFoundMessage('Verified senders'),
                }));
            }
            catch (error) {
                console.log(error.response.body);
        ...
        this.thirdPartySignIn = async (req, res) => {
            try {
        ...
        this.getSignatures = async (req, res) => {
            try {
                const response = await this.userService.getSignatures(req);
                if (!response[0]) {
                    return res
                        .status(constants_util_1.default.CODE.OK)
                        .send(responseHelper_util_1.default.get4xxResponse(response[1]));
                ...
                return res.status(constants_util_1.default.CODE.OK).send(responseHelper_util_1.default.get2xxResponse({
                    statusCode: constants_util_1.default.CODE.OK,
                    data: response[1],
                    message: constants_util_1.default.successFoundMessage('Signatures'),
                }));
            }
            catch (error) {
                return res
        ...
        this.addSignature = async (req, res) => {
            try {
                const response = await this.userService.addSignature(req);
                if (!response[0]) {
                    return res
                        .status(constants_util_1.default.CODE.BAD_REQUEST)
                        .send(responseHelper_util_1.default.get4xxResponse(response[1]));
                ...
                return res.status(constants_util_1.default.CODE.OK).send(responseHelper_util_1.default.get2xxResponse({
                    statusCode: constants_util_1.default.CODE.OK,
                    data: response[1],
                    message: constants_util_1.default.successAddMessage('Signature'),
                }));
            }
            catch (error) {
                return res
        ...
        this.updateSignature = async (req, res) => {
            try {
                const response = await this.userService.updateSignature(req);
                if (!response[0]) {
                    return res
                        .status(constants_util_1.default.CODE.BAD_REQUEST)
                        .send(responseHelper_util_1.default.get4xxResponse(response[1]));
                ...
                return res.status(constants_util_1.default.CODE.OK).send(responseHelper_util_1.default.get2xxResponse({
                    statusCode: constants_util_1.default.CODE.OK,
                    data: response[1],
                    message: constants_util_1.default.successUpdateMessage('Signature'),
                }));
            }
            catch (error) {
                return res
        ...
        this.deleteSignature = async (req, res) => {
            try {
                const response = await this.userService.deleteSignature(req);
                if (!response[0]) {
                    return res
                        .status(constants_util_1.default.CODE.BAD_REQUEST)
                        .send(responseHelper_util_1.default.get4xxResponse(response[1]));
                ...
                return res.status(constants_util_1.default.CODE.OK).send(responseHelper_util_1.default.get2xxResponse({
                    statusCode: constants_util_1.default.CODE.OK,
                    data: response[1],
                    message: constants_util_1.default.successDeleteMessage('Signature'),
                }));
            }
            catch (error) {
                return res
        ...
        this.updateSignatureStatus = async (req, res) => {
            try {
                const response = await this.userService.updateSignatureStatus(req);
                if (!response[0]) {
                    return res
                        .status(constants_util_1.default.CODE.BAD_REQUEST)
                        .send(responseHelper_util_1.default.get4xxResponse(response[1]));
        ...
        this.getUserActiveSignature = async (req, res) => {
            try {
                const response = await this.userService.getUserActiveSignature(req);
                if (!response[0]) {
                    return res
                        .status(constants_util_1.default.CODE.OK)
                        .send(responseHelper_util_1.default.get4xxResponse(response[1]));
                ...
                return res.status(constants_util_1.default.CODE.OK).send(responseHelper_util_1.default.get2xxResponse({
                    statusCode: constants_util_1.default.CODE.OK,
                    data: response[1],
                    message: constants_util_1.default.successFoundMessage('Signature'),
                }));
            }
            catch (error) {
                return res
