...
class EmailController {
    constructor() {
        ...
        this.emailThreading = async (req, res) => {
            try {
                ...
                return res.status(constants_util_1.default.CODE.OK).send(responseHelper_util_1.default.get2xxResponse({
                    statusCode: constants_util_1.default.CODE.OK,
                    data: response[1],
                    message: constants_util_1.default.successFoundMessage('Email threading'),
                }));
            }
            catch (error) {
                console.log(error);
        ...
        this.eachThreadingMails = async (req, res) => {
            try {
        ...
        this.threadsCompleted = async (req, res) => {
            try {
                ...
                return res.status(constants_util_1.default.CODE.OK).send(responseHelper_util_1.default.get2xxResponse({
                    statusCode: constants_util_1.default.CODE.OK,
                    data: response[1],
                    message: constants_util_1.default.successUpdateMessage('Email'),
                }));
            }
            catch (error) {
                console.log(error);
        ...
        this.getThreadsCompleted = async (req, res) => {
            try {
                ...
                return res.status(constants_util_1.default.CODE.OK).send(responseHelper_util_1.default.get2xxResponse({
                    statusCode: constants_util_1.default.CODE.OK,
                    data: response[1],
                    message: constants_util_1.default.successFoundMessage('Completed emails'),
                }));
            }
            catch (error) {
                console.log(error);
