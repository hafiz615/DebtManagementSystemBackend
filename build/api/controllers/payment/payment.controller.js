...
class PaymentController {
    constructor() {
        ...
        this.getCreditorSuccessfulPayments = async (req, res) => {
            try {
                const checkPermission = await common_util_1.default.checkPermission('viewHomeScreen', req);
                if (!checkPermission)
                    return res
                        .status(constants_util_1.default.CODE.BAD_REQUEST)
                        .send(responseHelper_util_1.default.get4xxResponse('You do not have permission to perform this operation'));
                const response = await this.paymentService.getCreditorSuccessfulPayments(req);
                if (!response[0]) {
                    return res
                        .status(constants_util_1.default.CODE.OK)
                        .send(responseHelper_util_1.default.get4xxResponse(response[1]));
        ...
        this.getCreditorUpcomingPayments = async (req, res) => {
            try {
                const checkPermission = await common_util_1.default.checkPermission('viewHomeScreen', req);
                if (!checkPermission)
                    return res
                        .status(constants_util_1.default.CODE.BAD_REQUEST)
                        .send(responseHelper_util_1.default.get4xxResponse('You do not have permission to perform this operation'));
                const response = await this.paymentService.getCreditorUpcomingPayments(req);
                if (!response[0]) {
                    return res
                        .status(constants_util_1.default.CODE.OK)
                        .send(responseHelper_util_1.default.get4xxResponse(response[1]));
        ...
        this.getCasePaymentsAnalytics = async (req, res) => {
            try {
                const checkPermission = await common_util_1.default.checkPermission('viewCaseDetails', req);
                if (!checkPermission)
                    return res
                ...
                return res.status(constants_util_1.default.CODE.OK).send(responseHelper_util_1.default.get2xxResponse({
                    statusCode: constants_util_1.default.CODE.OK,
                    data: response[1],
                    message: constants_util_1.default.successFoundMessage('Case payments analytics'),
                }));
            }
            catch (error) {
                return res
        ...
        this.getAllUpcomingPayments = async (req, res) => {
            try {
                const checkPermission = await common_util_1.default.checkPermission('viewCaseDetails', req);
                if (!checkPermission)
                    return res
        ...
        this.addAccount = async (req, res) => {
            try {
                const response = await this.paymentService.addAccount(req);
                if (!response[0]) {
                    return res
                        .status(constants_util_1.default.CODE.BAD_REQUEST)
                        .send(responseHelper_util_1.default.get4xxResponse(response[1]));
        ...
        this.cronSeamlesschex = async (req, res) => {
            try {
                ...
                return res.status(constants_util_1.default.CODE.OK).send(responseHelper_util_1.default.get2xxResponse({
                    statusCode: constants_util_1.default.CODE.OK,
                    data: [],
                    message: 'Cron-job for Seamlesschex completed successfully',
                }));
            }
            catch (error) {
                console.log(error);
        ...
        this.cancelCasePaymentPlan = async (req, res) => {
            try {
        ...
        this.cancelDebtorPaymentPlan = async (req, res) => {
            try {
        ...
        this.cancelAllDebtorPaymentPlan = async (req, res) => {
            try {
                const response = await this.paymentService.cancelAllDebtorPaymentPlan(req);
                if (!response[0]) {
                    return res
                        .status(constants_util_1.default.CODE.BAD_REQUEST)
                        .send(responseHelper_util_1.default.get4xxResponse(response[1]));
        ...
        this.getCommissionPayments = async (req, res) => {
            try {
                ...
                return res.status(constants_util_1.default.CODE.OK).send(responseHelper_util_1.default.get2xxResponse({
                    statusCode: constants_util_1.default.CODE.OK,
                    data: response[1],
                    message: constants_util_1.default.successFoundMessage('Commission payments'),
                }));
            }
            catch (error) {
                console.log(error);
        ...
        this.getRelatedPayments = async (req, res) => {
            try {
        ...
        this.updatePaymentLinkStatus = async (req, res) => {
            try {
                ...
                return res.status(constants_util_1.default.CODE.OK).send(responseHelper_util_1.default.get2xxResponse({
                    statusCode: constants_util_1.default.CODE.OK,
                    data: response[1],
                    message: constants_util_1.default.successUpdateMessage('Payment link status'),
                }));
            }
            catch (error) {
                console.log(error);
        ...
        this.updateACHDetails = async (req, res) => {
            try {
                const response = await this.paymentService.updateACHDetails(req);
                if (!response[0]) {
                    return res
                        .status(constants_util_1.default.CODE.OK)
                        .send(responseHelper_util_1.default.get4xxResponse(response[1]));
                ...
                return res.status(constants_util_1.default.CODE.OK).send(responseHelper_util_1.default.get2xxResponse({
                    statusCode: constants_util_1.default.CODE.OK,
                    data: response[1],
                    message: constants_util_1.default.successUpdateMessage('ACH details'),
                }));
            }
            catch (error) {
                console.log(error);
        ...
        this.getPaymentLinkStatus = async (req, res) => {
            try {
        ...
        this.addPaymentPlan = async (req, res) => {
            try {
                const response = await this.paymentService.addPaymentPlan(req);
                if (!response[0]) {
                    return res
                        .status(constants_util_1.default.CODE.BAD_REQUEST)
                        .send(responseHelper_util_1.default.get4xxResponse(response[1]));
        ...
        this.updatePaymentDate = async (req, res) => {
            try {
                const response = await this.paymentService.updatePaymentDate(req);
                if (!response[0]) {
                    return res
                        .status(constants_util_1.default.CODE.BAD_REQUEST)
                        .send(responseHelper_util_1.default.get4xxResponse(response[1]));
                ...
                return res.status(constants_util_1.default.CODE.OK).send(responseHelper_util_1.default.get2xxResponse({
                    statusCode: constants_util_1.default.CODE.OK,
                    data: [],
                    message: constants_util_1.default.successUpdateMessage('Payment'),
                }));
            }
            catch (error) {
                console.log(error);
        ...
        this.checkInvoice = async (req, res) => {
            try {
                const response = await this.paymentService.checkInvoice(req);
                if (!response[0]) {
                    return res
                        .status(constants_util_1.default.CODE.OK)
                        .send(responseHelper_util_1.default.get4xxResponse(response[1]));
        ...
        this.getInstantPayment = async (req, res) => {
            try {
                const response = await this.paymentService.getInstantPayment(req);
                if (!response[0]) {
                    return res
                        .status(constants_util_1.default.CODE.BAD_REQUEST)
                        .send(responseHelper_util_1.default.get4xxResponse(response[1]));
        ...
        this.getCaseAttorneyPayments = async (req, res) => {
            try {
                const response = await this.paymentService.getCaseAttorneyPayments(req);
                if (!response[0]) {
                    return res
                        .status(constants_util_1.default.CODE.BAD_REQUEST)
                        .send(responseHelper_util_1.default.get4xxResponse(response[1]));
        ...
        this.paynoteWebhook = async (req, res) => {
            try {
                const response = await this.paymentService.paynoteWebhook(req);
                if (!response[0]) {
                    return res
                        .status(constants_util_1.default.CODE.OK)
                        .send(responseHelper_util_1.default.get4xxResponse(response[1]));
                ...
                return res.status(constants_util_1.default.CODE.OK).send(responseHelper_util_1.default.get2xxResponse({
                    statusCode: constants_util_1.default.CODE.OK,
                    data: response[1],
                    message: 'Paynote webhook processed successfully',
                }));
            }
            catch (error) {
                console.log(error);
        ...
        this.getClientPendingChecks = async (req, res) => {
            try {
                const response = await this.paymentService.getClientPendingChecks(req);
                if (!response[0]) {
                    return res
                        .status(constants_util_1.default.CODE.OK)
                        .send(responseHelper_util_1.default.get4xxResponse(response[1]));
                ...
                return res.status(constants_util_1.default.CODE.OK).send(responseHelper_util_1.default.get2xxResponse({
                    statusCode: constants_util_1.default.CODE.OK,
                    data: response[1],
                    message: constants_util_1.default.successFoundMessage('Client pending checks'),
                }));
            }
            catch (error) {
                console.log(error);
        ...
        this.getClientPayments = async (req, res) => {
            try {
