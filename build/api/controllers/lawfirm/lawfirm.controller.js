...
const lawfirm_service_1 = __importDefault(require("../../services/lawfirm.service"));
...
class LawfirmController {
    constructor() {
        this.createLawfirm = async (req, res) => {
            try {
                ...
                return res.status(constants_util_1.default.CODE.OK).send(responseHelper_util_1.default.get2xxResponse({
                    ...
                    data: response[1],
                    message: constants_util_1.default.successRegisterMessage('Lawfirm'),
                }));
            }
            catch (error) {
        ...
        this.updateLawfirm = async (req, res) => {
            try {
                ...
                return res.status(constants_util_1.default.CODE.OK).send(responseHelper_util_1.default.get2xxResponse({
                    ...
                    data: response[1],
                    message: constants_util_1.default.successUpdateMessage('Lawfirm'),
                }));
            }
            catch (error) {
                console.log(error);
        ...
        this.getLawfirm = async (req, res) => {
            try {
                ...
                return res.status(constants_util_1.default.CODE.OK).send(responseHelper_util_1.default.get2xxResponse({
                    statusCode: constants_util_1.default.CODE.OK,
                    data: response[1],
                    message: constants_util_1.default.successFoundMessage('Lawfirms'),
                }));
            }
            catch (error) {
                console.log(error);
        ...
        this.assignLawfirmToCase = async (req, res) => {
            try {
                ...
                return res.status(constants_util_1.default.CODE.OK).send(responseHelper_util_1.default.get2xxResponse({
                    statusCode: constants_util_1.default.CODE.OK,
                    data: response[1],
                    message: constants_util_1.default.successAddMessage('Lawfirm'),
                }));
            }
            catch (error) {
                console.log(error);
        ...
        this.updateLawsuit = async (req, res) => {
            try {
                ...
                return res.status(constants_util_1.default.CODE.OK).send(responseHelper_util_1.default.get2xxResponse({
                    statusCode: constants_util_1.default.CODE.OK,
                    data: response[1],
                    message: constants_util_1.default.successUpdateMessage('Lawsuit'),
                }));
            }
            catch (error) {
                console.log(error);
        ...
        this.addAttorney = async (req, res) => {
            try {
                ...
                return res.status(constants_util_1.default.CODE.OK).send(responseHelper_util_1.default.get2xxResponse({
                    statusCode: constants_util_1.default.CODE.OK,
                    data: response[1],
                    message: constants_util_1.default.successAddMessage('Attorney'),
                }));
            }
            catch (error) {
                console.log(error);
...
exports.default = new LawfirmController();
